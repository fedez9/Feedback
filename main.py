...
async def traccia_utente(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # 4. Salva su Firebase SOLO se qualcosa è effettivamente cambiato.
    # Prima veniva salvato l'intero dizionario ad ogni messaggio, generando
    # un enorme traffico di rete inutile verso Firebase.
    if data_changed:
